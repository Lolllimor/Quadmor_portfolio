...
const Works = () => {
  ...
  return (
    <main className="px-[50px] pt-[36px] flex flex-col items-center w-full max-[500px]:px-0 max-[500px]:pt-0 ">
      <div className="gap-[30px] w-full flex border border-[#fff] rounded-[24px] max-[500px]:pt-[14px] max-[500px]:mx-[24px] max-[500px]:pb-[29px] mx-[88px] mt-[92px] max-[500px]:mt-[50px] max-[500px]:flex-col  pt-[46px] px-[51px] pb-[76px] mb-[400px] max-[500px]:px-[31px] max-[500px]:mb-[100px]">
        <div className="w-[45%] max-[800px]:w-full">
          <h1 className="text-[60px] font-[500] w-[100%] max-[1440px]:text-[50px]  max-[500px]:text-[35px]">
          ...
          <div className="grid grid-cols-2 gap-[50px]">
            ...
            >
              <div
                ...
                className=" max-[1440px]:w-[250px] w-[290px] max-[500px]:w-[132px] max-[500px]:h-[171px] max-[500px]:rounded-[11px] p-[32px] flex flex-col justify-between items-end h-[431px] border border-[#fff] rounded-[32px] max-[500px]:p-2.5"
              >
                ...
                <div className=" max-[500px]:w-full max-[500px]:flex max-[500px]:items-start">
                  <img
                    ...
                    className="h-[88px] w-[83px] max-[500px]:w-[39px] max-[500px]:h-[39px] "
                  />
                </div>
              </div>
